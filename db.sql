...
INSERT INTO songs (title, artist, spotify_track_id, display_order) VALUES
  ...
  ('Levitating',           'Dua Lipa',                         '39LLxExYz6ewLAcYrzQQyP',  5),
  ('Stay',                 'The Kid LAROI & Justin Bieber',    '5HCyWlXZPP0y6Gqq8TgA20',  6),
  ('drivers license',      'Olivia Rodrigo',                   '5wANPM4fQCJwkGd4rN57mH',  7),
  ...
  ('Kiss Me More',         'Doja Cat ft. SZA',                 '3DarAbFujv6eYNliUTyqtz', 14),
  ('Butter',               'BTS',                              '1mWdTewIgB3gtBM3TOSFhB', 15),
