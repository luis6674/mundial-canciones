...
<div class="login-form" id="login-form">
  <div class="login-checkboxes">
    <label class="checkbox-label" id="lf-label-1">
      <input type="checkbox" id="lf-check-1">
    ...
    <label class="checkbox-label" id="lf-label-2">
  ...
  <p class="login-form-error" id="lf-error" hidden>Debes aceptar la Política de Privacidad para continuar.</p>
